...
function FBAsol = solveFBA_simulationMOMA(model,t,p,geneID)

%Parameters used in solveFBA:

if feedFunction(t) == 0
    w = p(15);   %Fraction of optimum growth that cell follows - BATCH[-]
else
    w = p(16);  %Fraction of optimum growth that cell follows - FEDBATCH [-]
end
