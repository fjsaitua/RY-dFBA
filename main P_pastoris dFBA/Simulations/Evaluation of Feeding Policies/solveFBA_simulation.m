...
function FBAsol = solveFBA_simulation(model,t,xWT,p)

%Parameters used in solveFBA:
if feedFunction(t) == 0
    a = p(15);   %Fraction of optimum growth that cell follows - BATCH[-]
else
    a = p(16);  %Fraction of optimum growth that cell follows - FEDBATCH [-]
end
